...
class Header
{
    ...
    {
        return \trim(substr(wordwrap(
            $this->NameWithDelimitrom().$sValue,
            \MailSo\Mime\Enumerations\Constants::LINE_LENGTH,
            $sGlue
...
//					'scheme' => \MailSo\Base\Enumerations\Encoding::QUOTED_PRINTABLE_SHORT,
        ...
        } elseif ($this->IsParameterized() && $this->oParameters && 0 < $this->oParameters->Count()) {
